...
public class App1 {
    List<Article1> articles = new ArrayList<>();
    int no = 1;
    ...
    private Article1 findArticleById(int index) {
    ...
    private void addPost() {
        ...
        Article1 article = new Article1(no, title, body);
    ...
    public void addDefaultPosts() {
        ...
        Article1[] defaultArticles = {
                new Article1(no++, "안녕하세요 반갑습니다. 자바 공부중이에요.", "첫번째 게시물 내용입니다."),
                new Article1(no++, "자바 질문좀 할게요~", "두번째 게시물 내용입니다."),
                new Article1(no++, "정처기 따야되나요?", "세번째 게시물 내용입니다.")
        };

        for (Article1 article : defaultArticles) {
            article.setRegistrationDate(now);
            articles.add(article);
        }
    ...
    private void deletePost() {
        ...
        Article1 article = findArticleById(index);
    ...
    private void searchPost() {
        ...
        List<Article1> searchResults = new ArrayList<>();
        ...
        if (searchResults.isEmpty()) {
            ...
            System.out.println("==================");
            for (Article1 article : searchResults) {
                System.out.println("번호: " + article.getNo());
                System.out.println("제목: " + article.getTitle());
                System.out.println("==================");
            }
